...
import { Menu, Bell, Plus, Search, ChevronDown, RefreshCw, Check, X, Ban, Package, Clock } from 'lucide-react-native';
...
export default function ResourcesRequestScreen() {
    ...
    const TableRow = ({ type, id, status, qty, canApprove = false }: any) => (
        <View className="flex-row items-center px-6 py-4 border-b border-gray-50">
            ...
            <View className="flex-1 items-center flex-row justify-center">
                <Package size={14} color="#3B82F6" className="mr-2" />
    ...
    return (
        <View className="flex-1 bg-gray-50 flex-col">
            ...
            <TopHeader title="Resources Requests" subtitle="{title}" />
            ...
            <ScrollView className="flex-1" contentContainerStyle={{ padding: 16, paddingBottom: 60 }}>
                ...
                <View className="flex-row flex-wrap justify-between items-center mb-6">
                    <View className="mb-4 md:mb-0">
                        <Text className="text-2xl font-bold text-gray-900">Resources Request</Text>
                        <Text className="text-sm text-gray-500 mt-1">Formal procurement requests for structural and consumable site resources.</Text>
                    </View>
                ...
                <View className="flex-row flex-wrap -mx-2 mb-6">
                    <StatCard title="TOTAL LOGS" value="13" subtitle="All Requests" valueColor="text-gray-900" />
                    <StatCard title="APPROVED" value="3" subtitle="Released for Site" valueColor="text-green-500" />
                    <StatCard title="PENDING REVIEW" value="7" subtitle="PM Validation" valueColor="text-yellow-500" />
                    <StatCard title="FULFILLMENT" value="23%" subtitle="Procurement Yield" valueColor="text-blue-500" />
                </View>
                ...
                <View className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
                    ...
                    <View className="p-4 border-b border-gray-100 flex-row flex-wrap items-center justify-between">
                        <View className="flex-row items-center bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 w-full md:w-1/3 lg:w-1/3 mb-4 md:mb-0">
                            ...
                            <TextInput className="flex-1 font-medium text-sm text-gray-800" placeholder="Search by material type or requisition ID..." placeholderTextColor="#9CA3AF" />
                        </View>
                        <View className="flex-row items-center space-x-4 w-full md:w-auto">
                            ...
                            <View className="flex-row items-center bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 mr-3 justify-between min-w-[120px]">
                                <Text className="font-bold text-xs text-blue-600">ALL RESOURCES</Text>
                                <ChevronDown size={14} color="#3B82F6" />
                            </View>
                            
                            <View className="flex-row items-center bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 justify-between min-w-[100px]">
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={true} className="w-full">
                        <View className="min-w-[900px] flex-1">
                            ...
                            <View className="flex-row items-center px-6 py-4 bg-gray-50 border-b border-gray-100">
                                <Text className="flex-1 text-[10px] font-bold text-gray-400 uppercase tracking-widest">RESOURCE REQUISITION</Text>
                                <Text className="flex-1 text-[10px] font-bold text-gray-400 uppercase tracking-widest text-center">OPERATIONAL STATUS</Text>
                                <Text className="flex-1 text-[10px] font-bold text-gray-400 uppercase tracking-widest text-center">VOLUME / QUANTITY</Text>
                                <Text className="flex-1 text-[10px] font-bold text-gray-400 uppercase tracking-widest text-right">ACTIONS</Text>
                            </View>
                            
                            {/* Table Rows */}
                            <TableRow type="LABOUR" id="OMHJUMJ" status="PENDING" qty="100 Units" canApprove={true} />
                            <TableRow type="MATERIAL" id="TJJJHG" status="APPROVED" qty="100 Units" canApprove={false} />
                            <TableRow type="WORK" id="ZFSVRTDFGHDFH" status="PENDING" qty="50 Units" canApprove={true} />
                            <TableRow type="LABOUR" id="JHUBFTGJLHYE" status="PENDING" qty="15 Units" canApprove={true} />
                            <TableRow type="EQUIPMENT" id="UORPEUGBIP;" status="PENDING" qty="100 Units" canApprove={true} />
                            <TableRow type="LABOUR" id="URTGHDFGDFGRFDG" status="REJECTED" qty="100 Units" canApprove={false} />
                            <TableRow type="EQUIPMENT" id="WSDFVWESRTFTE" status="APPROVED" qty="100 Units" canApprove={false} />
                            <TableRow type="EQUIPMENT" id="TJJJHY" status="PENDING" qty="100 Units" canApprove={true} />
                            <TableRow type="LABOUR" id="SDYTFDT" status="PENDING" qty="2 Units" canApprove={true} />
                        </View>
                    </ScrollView>
                </View>
            </ScrollView>
