        ...
        <View className="flex-1 bg-gray-50">
            <View className="px-4 pt-14 pb-4 bg-blue-600">
                <View className="flex-row items-center">
                    ...
                    <Text className="text-xl font-bold text-white">Banking</Text>
                </View>
                <Text className="text-[10px] text-blue-100 mt-1">InfraPilot &gt; Accountant &gt; Banking</Text>
            </View>
            <View className="flex-1 items-center justify-center">
                <Text className="text-xl font-bold text-gray-700">Banking</Text>
